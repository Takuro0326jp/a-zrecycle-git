...
<head>
	...
	<title><?php echo wp_title('-', true, 'right') . bloginfo('name'); ?> | 家具・家電・楽器の買取専門ショップ「a door アドア」 </title>
	<meta name="description" content="<?php echo wp_title('-', true, 'right') . bloginfo('name'); ?> | 家具・家電・楽器の買取専門ショップ「a door アドア」" />
...
//-->
	...
	<div class="headerarea">
		...
		<div class="header_phone">
			...
			<img src="/images/additional/header_phone.jpg" width="208" height="40" alt="フリーダイヤル0120-531-017 受付時間：9:00～21:00" />
		</div>
