...
$customer_message = $_SESSION['user']['UserName'] . "様" . "\n" .
	...
	"本メールにご返信いただいても、お答えすることができません。" . "\n" .
	"お問い合わせは、下記に記載のお電話にてお願いします。" . "\n" .
	"\n" .
	"-----------------------------------------------" . "\n" .
	"a door" . "\n" .
...
for ($i = 0; $i <= $item_seq - 1; $i++) {
	...
	if ($items[$i]['cat'] == "furniture") {
		...
		$items_content .= "\nブランド家具・デザイナーズ家具" . "\n" .
			...
			"コンディション: " . $items[$i]['itemCondition'] . "\n" .
			"サイズ: " . $items[$i]['itemSize'] . "\n" .
			"材質: " . $items[$i]['itemMaterial'] . "\n" .
			"買い取れない場合は: " . $itemThrowAway . "\n" .
			"アイテムのアピール: " . $items[$i]['itemAppeal'] . "\n" .
			"当店へのメッセージ: " . $items[$i]['itemComment'] . "\n";
		$pictures_content = "アイテム画像1: " . $UrlFinalpicture1 . "\n" .
...
再度お申し込みフォームにお送りいただくか、下記までお問い合わせください。<br />
TEL：03-3706-3380";
}
?>
...
<!--form start-->
<div><img src="images/img_step1.gif" /><img src="images/img_step2.gif" /><img src="images/img_step3.gif" /><img src="images/img_step4_o.gif" /></div><br />
