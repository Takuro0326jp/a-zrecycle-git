<?php
	...
	if($_GET['categ'] == "electronicDevice"){
		...
		<table border="0" cellpadding="0" cellspacing="0" class="form_tbl">
			...
			<tr>
				<td class="form_td02">アイテム画像1 <br /><span class="redSubtitle">より正確な見積のためにできるだけ画像を添付してください</span></td>
				...
				<?php }?>
				（300KBまで）※ファイル名は必ず半角英数字にて指定の上、アップロードして下さい。
				</td>
			</tr>			
			<tr>
