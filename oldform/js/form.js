...
function check_form(thisForm, val){
	...
	if(val != 2){
		...
		//********************_______家電______********************
		if(thisForm.itemCategory.selectedIndex == 1 || thisForm.itemCategory.options[0].value == 'electronicDevice' ){
		...
		if(thisForm.itemCategory.selectedIndex == 2 || thisForm.itemCategory.options[0].value == 'furniture'){
